package com.example.matt.exoplayer2_livehls;
...
public class MainActivity extends BrightcovePlayer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Catalog catalog = new Catalog(eventEmitter, getString(R.string.accountID2), getString(R.string.policyKey2));
        catalog.findVideoByID(getString(R.string.videoID2), new VideoListener() {
    ...
    private void setupGoogleIMA() {
        ...
        eventEmitter.on(GoogleIMAEventType.ADS_REQUEST_FOR_VIDEO, new EventListener() {
            ...
            public void processEvent(Event event) {
                ...
                adsRequest.setAdTagUrl(adRulesURL2);
